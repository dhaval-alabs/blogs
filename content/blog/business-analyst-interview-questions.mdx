...
featuredImage: "https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2022/09/Business-Analyst-Interview-Questions-1-1.png"
author: AnalytixLabs
categories:
  - Business Analyst
  - Business Analytics
...
![business analytics terminology](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2022/09/Line-Graphic-2.png)
...
![business analyst role](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2022/09/business-analyst-role.png)
...
| **Diagram** | **What is it** |
| --- | --- |
| Activity Diagram | The activity reflects the operations of a system. An activity diagram is a diagrammatic representation of the workflow from one activity to another activity and showcases the variations within departments of the firm. It visually represents the various activities of a firm with the respective workflow across different departments of a firm such as Marketing, HR, Sales, Finance & Accounts, et al. The important components in the activity diagram are initial nodes, activities, control flows, decisions, a fork, guard conditions, joins, and end nodes |
...
| Collaboration Diagram | The collaboration diagram illustrates the relationships and communication between the software objects in the Unified Modeling Language (UML). It visually represents it by showing the messages flowing between them. These are also known as interaction or communication diagrams |
...
| --- | --- |
| Fundamental Skills | Communication (Verbal, Written skills)Problem-SolvingAnalytical and logical thinkingLeadership and management skillsResearchDocumentation skillsDecision-making and ability to PrioritizeRequirement ElicitationBusiness Process Management |
| Technical Skills | MS Office SuiteGoogle DocsERP SystemsProgramming languagesQuerying languages: SQLDatabase KnowledgeData ModelingSDLC knowledgeDomain or functional knowledgeScrum ManagementBusiness Analysis skills |

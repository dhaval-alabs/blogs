...
featuredImage: "https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2023/01/become-a-data-scientist.webp"
author: AnalytixLabs
categories:
  - Data Science
tags:
...
![Data Science Components](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/Data-Science-Components.png)
...
| Step 03 | Data Understanding | Once you have the relevant data, you perform data mining and exploration to identify the features of interest. You need to understand the relations that the attributes have with each other. Knowing about statistics is vital at this stage | R, SAS |
| Step 04 | Data Modeling | You then start with creating a predictive model. Here knowledge of algorithms and the mathematics behind them is crucial. Programming skills become relevant at this stage when you have to develop the models | Python and R |
...
| **What to Learn** | **Why?** |
| --- | --- |
| Excel | Starting with a spreadsheet helps in gaining an understanding of the data and basic analytical techniques |
| SQL | To better understand datasets and data, warehousing SQL is a must. You can pick MYSQL as the tool, and SQL will also help you when you start with big data later |
| VBA | You have to start programming at some point, and a gentle introduction can be through VBA done in MS Excel |
| Visualization and Reporting | Once introduced to programming, you can take a break and start learning about visualization and creating graphs using tools like Tableau, Power BI, etc. |
| R and Statistics | Statistics is the backbone of data science. You need to start with the statistics theory at this point and to put it to practical use by learning R |
| Data Manipulation and Basic programming using Python | You can finally start with Python and perform data manipulation using libraries like NumPy and pandas |
| Predictive Modeling with conventional data | Regression, Classification, Segmentation, and Forecasting are the basic problems solved through predictive models. You need to learn about all the relevant algorithms that can solve all such issues. These algorithms include linear regression, logistic regression, decision trees, K-means clustering, ARIMA, etc. |
| Machine Learning | Once familiar with the algorithms mentioned earlier, you can begin with machine learning algorithms like support vector machines, KNN, Random Forest, etc. |
| Solving Complex problems using AI | You should solve problems with unconventional data, including text, images, audio, video, etc. Here knowledge of deep learning algorithms needs to be gained |
| Model Deployment & Cloud Computing | Ideally, you should also learn about creating applications to deploy your models. This will include knowledge of Django, Flask, etc. Often models are deployed on the cloud, so it’s the right time to learn about AWS, Azure, and GCP |
| Big Data | If you want to enter the field of data engineering and data architecture, getting yourself familiar with big data is a must. You should learn about the fundamentals of big data and HDFS theory and learn tools like MapReduce, Sqoop, Hive, Spark, Kafka, etc. |
...
![data scientist jobs](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/data-scientist-jobs-.png)
...
![data scientist salary by industry](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/Screenshot-2023-01-23-at-6.57.09-PM.png)
...
![salary tier 1 vs tier 2](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/salary-tier-1-vs-tier-2-1.png)
...
![data scientist salary by gender](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/Screenshot-2023-01-23-at-7.04.25-PM.png)
...
![data scientist technical skills](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/Screenshot-2023-01-24-at-3.18.31-PM.png)
...
![data scientist non technical skills](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/A4-40.png)
...
![data science tools](https://tumfgdyurswklrzsnevv.supabase.co/storage/v1/object/public/uploads/wp-content/uploads/2020/06/Screenshot-2023-01-24-at-3.43.44-PM.png)

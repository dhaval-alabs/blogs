...
// Just the interactive estimator (form + result card) — page shell (Navbar,
// intro copy, methodology/FAQ, Footer) lives in the Server Component wrapper
// at page.js so it can carry generateMetadata + JSON-LD, which "use client"
// components can't export.
export default function SalaryHubClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-6 flex flex-col md:flex-row gap-12">

        {/* Left Side: Form */}
        <div className="w-full md:w-1/2 space-y-8">
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold font-[family-name:var(--font-headline)] mb-4 tracking-tight">

      ...
      {dynamicAuthor?.is_super_admin ? (
         <>
           ...
           <Link
              ...
              className={`sb-nav ${pathname === '/studio/subscribers' ? 'active' : ''}`}
            >
            ...
            <Link
               ...
               className={`sb-nav ${pathname === '/studio/redirects' ? 'active' : ''}`}
             >
               <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 3h5v5M4 20L21 3M21 16v5h-5M15 15l6 6M4 4l5 5"/></svg>
               Redirects
             </Link>
         </>
      ) : (
